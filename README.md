...
### 기타
![alt text](<image/회원 정보 확인.png>)
- 로그인 시 회원 정보를 확인할 수 있는 페이지와 푸터를 제작했습니다.

<hr/>

### 후기
와, 처음에 컴포넌트를 만들고 데이터를 불러들이는 것까지는 빠르고 쾌적하게 진행할 수 있어서 이거 완성도 높이기도 잘 되겠구나 하는 생각을 했습니다마는 로그인 기능을 붙이기 시작하면서부터 굉장한 난관과 맞닥뜨리고 말았습니다. 액세스 토큰 갱신이 잘 안 돼서 로그인 유지 기능과 로그아웃 기능이 잘 구현되지 않았기 때문입니다. 과제 제출 직전까지도 백엔드 분들의 도움 아래 어떻게든 해결해 보려 노력했지만 결국 잘 되지 않았습니다. 너무 슬픕니다. 그저 회원 가입의 유효성 검사는 완성도를 높일 수 있었다는 사실과 이번 과제에서는 열심히 노력했다는 사실에만 만족하려 합니다.
<hr/>
